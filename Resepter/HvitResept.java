class HvitResept extends Resept{ //Oppretter subklassen HvitResept som utvidelse av superklassen Resept.
    ...
    HvitResept(Legemiddel legemiddel, Lege utskrivendelege, int pasientID, int reit){ //Skriver konstruktøren og bruker spuer() til å arve parametere fra superklassen. 
